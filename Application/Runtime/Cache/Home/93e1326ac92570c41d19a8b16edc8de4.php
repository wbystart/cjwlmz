...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="/Public/Home/wlmz/js/html5shiv.js"></script>
    <![endif]-->


    <!-- CSS Files
    ================================================== -->
    <link rel="stylesheet" href="/Public/Home/wlmz/css/bootstrap.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/jpreloader.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/animate.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/flexslider.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/plugin.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/prettyPhoto.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/owl.carousel.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/owl.theme.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/style.css" type="text/css">

    <!-- custom style css -->
    <link rel="stylesheet" href="/Public/Home/wlmz/css/custom-style.css" type="text/css">

    <!-- color scheme -->
    <link rel="stylesheet" href="/Public/Home/wlmz/css/color.css" type="text/css">

    <!-- revolution slider -->
    <link rel="stylesheet" href="/Public/Home/wlmz/rs-plugin/css/settings.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/css/rev-settings.css" type="text/css">

    <!-- load fonts -->
    <link rel="stylesheet" href="/Public/Home/wlmz/fonts/font-awesome/css/font-awesome.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/fonts/elegant_font/HTML_CSS/style.css" type="text/css">
    <link rel="stylesheet" href="/Public/Home/wlmz/fonts/et-line-font/style.css" type="text/css">
</head>
...
<body id="homepage">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 id="logo">
                            <a href="index.html">
                                <img class="logo-1" src="/Public/Home/wlmz/images/logo.png" alt="">
                                <img class="logo-2" src="/Public/Home/wlmz/images/logo-2.png" alt="">
                            </a>
                        </h1>
                        <!-- logo close -->
        ...
        <div id="content" class="no-bottom no-top">
                ...
                <div class="de-video-container">
                    <div class="de-video-content">
                        <div class="text-center">
                            ...
                            <div class="spacer-single"></div>
                            <a href="#" class="btn btn-border btn-big">Our Portfolio</a>
                        </div>
                    </div>
                    ...
                    <video autoplay="" loop="" muted="" poster="/Public/Home/wlmz/video/video2.jpg">
                        <source src="/Public/Home/wlmz/video/video2.webm" type="video/webm" />
                        <source src="/Public/Home/wlmz/video/video2.mp4" type="video/mp4" />
                        <source src="/Public/Home/wlmz/video/video2.ogg" type="video/ogg" />
                    </video>
            ...
            <section class="no-padding dark" data-speed="5" data-type="background">
                <div class="de-video-container">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3 text-center">
                                    ...
                                    <div class="animated" data-animation="fadeInUp">
                                        ...
                                        <div class="spacer-single"></div>
                                        <a href="#" class="btn btn-border" data-animation="fadeIn">Click Here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- load your video here -->
                    <video autoplay="" loop="" muted="" poster="/Public/Home/wlmz/video/video1.jpg">
                        <source src="/Public/Home/wlmz/video/video1.webm" type="video/webm" />
                        <source src="/Public/Home/wlmz/video/video1.mp4" type="video/mp4" />
                        <source src="/Public/Home/wlmz/video/video1.ogg" type="video/ogg" />
                    </video>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="de-team-list col-md-3 animated" data-animation="fadeInUp" data-delay="0">
                            <div class="team-pic">
                                <img src="/Public/Home/wlmz/images/team/team_pic_1.jpg" class="img-responsive" alt="" />
                            </div>
                        ...
                        <div class="de-team-list col-md-3 animated" data-animation="fadeInUp" data-delay="0">
                            <div class="team-pic">
                                <img src="/Public/Home/wlmz/images/team/team_pic_2.jpg" class="img-responsive" alt="" />
                            </div>
                            <div class="team-desc col-md-12">
                                <h3>John Smith</h3>
                                <p class="lead">Creative Director</p>
                        ...
                        <div class="de-team-list col-md-3 animated" data-animation="fadeInUp" data-delay="0">
                            <div class="team-pic">
                                <img src="/Public/Home/wlmz/images/team/team_pic_3.jpg" class="img-responsive" alt="" />
                            </div>
                            <div class="team-desc col-md-12">
                                <h3>John Smith</h3>
                                <p class="lead">Creative Director</p>
                        ...
                        <div class="de-team-list col-md-3 animated" data-animation="fadeInUp" data-delay="0">
                            <div class="team-pic">
                                <img src="/Public/Home/wlmz/images/team/team_pic_4.jpg" class="img-responsive" alt="" />
                            </div>
                            <div class="team-desc col-md-12">
                                <h3>John Smith</h3>
                                <p class="lead">Creative Director</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center animated" data-animation="fadeInUp" data-delay="400">
                            <img src="/Public/Home/wlmz/images/cubic_ss.png" class="img-responsive" alt="">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div id="gallery" class="gallery full-gallery de-gallery pf_full_width animated" data-animation="fadeInUp" data-delay="200">
                    ...
                    <div class="item illustration">
                        <div class="picframe">
                            <span class="overlay">
                                <span class="icon">
                                    <a href="/Public/Home/wlmz/images/portfolio/pf%20(1).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                                </span>
                                <span class="icon">
                                    <i class="fa fa-align-justify fa-external-link icon-info"></i>
                                </span>
                                <span class="pf_text">
                            ...
                            <img src="/Public/Home/wlmz/images/portfolio/pf%20(1).jpg" alt="" />
                        </div>
                    </div>
                    <!-- close gallery item -->
                    ...
                    <div class="item mobile website">
                        <div class="picframe">
                            <span class="overlay">
                                <span class="icon">
                                    <a href="/Public/Home/wlmz/images/portfolio/pf%20(2).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                            ...
                            <img src="/Public/Home/wlmz/images/portfolio/pf%20(2).jpg" alt="" />
                        </div>
                    </div>
                    <!-- close gallery item -->
                    ...
                    <div class="item website mobile">
                        <div class="picframe">
                            <span class="overlay">
                                <span class="icon">
                                    <a href="/Public/Home/wlmz/images/portfolio/pf%20(3).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                                </span><span class="icon">
                                    <i class="fa fa-align-justify fa-external-link icon-info"></i>
                                </span>
                                <span class="pf_text">
                            ...
                            <img src="/Public/Home/wlmz/images/portfolio/pf%20(3).jpg" alt="" />
                        </div>
                    </div>
                    <!-- close gallery item -->
                    ...
                    <div class="item illustration photography">
                        <div class="picframe">
                            <span class="overlay">
                                <span class="icon">
                                    <a href="/Public/Home/wlmz/images/portfolio/pf%20(4).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                                </span><span class="icon">
                                    <i class="fa fa-align-justify fa-external-link icon-info"></i>
                                </span>
                                <span class="pf_text">
                            ...
                            <img src="/Public/Home/wlmz/images/portfolio/pf%20(4).jpg" alt="" />
                        </div>
                    </div>
                    <!-- close gallery item -->
                    ...
                    <div class="item website photography mobile">
                        <div class="picframe">
                            <span class="overlay">
                                <span class="icon">
                                    <a href="/Public/Home/wlmz/images/portfolio/pf%20(5).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                                </span><span class="icon">
                                    <i class="fa fa-align-justify fa-external-link icon-info"></i>
                                </span>
                                <span class="pf_text">
                            ...
                            <img src="/Public/Home/wlmz/images/portfolio/pf%20(5).jpg" alt="" />
                        </div>
                    </div>
                    <!-- close gallery item -->
                    ...
                    <div class="item illustration website">
                        <div class="picframe">
                            <span class="overlay">
                                <span class="icon">
                                    <a href="/Public/Home/wlmz/images/portfolio/pf%20(6).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                                </span><span class="icon">
                                    <i class="fa fa-align-justify fa-external-link icon-info"></i>
                                </span>
                                <span class="pf_text">
                            ...
                            <img src="/Public/Home/wlmz/images/portfolio/pf%20(6).jpg" alt="" />
                        </div>
                    </div>
                    <!-- close gallery item -->
            ...
            <section id="view-all-projects" class="call-to-action bg-color dark text-center" data-speed="5" data-type="background">
                <a href="#" class="btn btn-border btn-big">View All Projects</a>
            </section>
                    ...
                    <div id="testimonial-carousel" class="de_carousel row animated" data-animation="fadeInUp" data-delay="200">
                            ...
                            <div class="de_testi">
                                ...
                                <div class="de_testi_by">
                                    <div class="de_testi_pic">
                                        <img src="/Public/Home/wlmz/images/testi_pic%20(1).jpg" alt="" class="img-circle">
                                    </div>
                            ...
                            <div class="de_testi">
                                ...
                                <div class="de_testi_by">
                                    <span class="de_testi_pic">
                                        <img src="/Public/Home/wlmz/images/testi_pic%20(2).jpg" alt="" class="img-circle"></span>
                                    <div class="de_testi_company">
                        ...
                        <div class="col-md-4 item">
                            <div class="de_testi">
                                ...
                                <div class="de_testi_by">
                                    <div class="de_testi_pic">
                                        <img src="/Public/Home/wlmz/images/testi-default.jpg" alt="" class="img-circle">
                                    </div>
                                    <div class="de_testi_company">
                                        <strong>Feldhouse</strong>, Customer
                                    </div>
            ...
            <section id="section-blog">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="animated" data-animation="fadeInUp">The <span class="id-color">Blog</span>
                            <span class="small-border animated" data-animation="fadeInUp"></span>
                            </h1>
                                ...
                                <div class="post-content">
                                    <div class="post-image">
                                        <div class="flexslider blog-slider">
                                            ...
                                            <ul class="slides">
                                                <li>
                                                    <img src="/Public/Home/wlmz/images/blog/pic-blog-1.jpg" alt="" />
                                                </li>
                                                <li>
                                                    <img src="/Public/Home/wlmz/images/blog/pic-blog-2.jpg" alt="" />
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="post-content">
                                    <div class="post-image">
                                        <div class="flexslider blog-slider">
                                            ...
                                            <ul class="slides">
                                                <li>
                                                    <img src="/Public/Home/wlmz/images/blog/pic-blog-3.jpg" alt="" />
                                                </li>
                                                <li>
                                                    <img src="/Public/Home/wlmz/images/blog/pic-blog-4.jpg" alt="" />
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="post-content">
                                    <div class="post-image">
                                        <div class="flexslider blog-slider">
                                            ...
                                            <ul class="slides">
                                                <li>
                                                    <img src="/Public/Home/wlmz/images/blog/pic-blog-5.jpg" alt="" />
                                                </li>
                                                <li>
                                                    <img src="/Public/Home/wlmz/images/blog/pic-blog-6.jpg" alt="" />
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="row">
                        <div class="logo-carousel">
                                    <ul id="logo-carousel" class="slides">
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/1.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/2.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/3.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/4.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/5.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/6.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/7.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="/Public/Home/wlmz/images/logo/8.png" alt="">
                                            </div>
                                        </li>
                                    </ul>
                        </div>
    ...
    <!-- Javascript Files
    ================================================== -->
    <script src="/Public/Home/wlmz/js/jquery.min.js"></script>
    <script src="/Public/Home/wlmz/js/jpreLoader.js"></script>
    <script src="/Public/Home/wlmz/js/bootstrap.min.js"></script>
    <script src="/Public/Home/wlmz/js/jquery.isotope.min.js"></script>
    <script src="/Public/Home/wlmz/js/jquery.prettyPhoto.js"></script>
    <script src="/Public/Home/wlmz/js/easing.js"></script>
    <script src="/Public/Home/wlmz/js/jquery.ui.totop.js"></script>
    <script src="/Public/Home/wlmz/js/jquery.flexslider-min.js"></script>
    <script src="/Public/Home/wlmz/js/jquery.scrollto.js"></script>
    <script src="/Public/Home/wlmz/js/owl.carousel.js"></script>
    <script src="/Public/Home/wlmz/js/jquery.countTo.js"></script>
    <script src="/Public/Home/wlmz/js/classie.js"></script>
    <script src="/Public/Home/wlmz/js/designesia.js"></script>
    <script src="/Public/Home/wlmz/js/validation.js"></script>

    <!-- SLIDER REVOLUTION SCRIPTS  -->
    <script type="text/javascript" src="/Public/Home/wlmz/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
    <script type="text/javascript" src="/Public/Home/wlmz/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
